...
def parse_args():
    parser = argparse.ArgumentParser(
        description='Script for preprocess dataset ShanghaiTech Part_B')

    parser.add_argument('--data-root', type=str,
                        default='~/workspace/datasets/SHHB',
...
def main():
    ...
    if dst_data_root is None:
        ...
        dst_data_root = osp.join(project_path, 'processed_data/SHHB')
    else:
        dst_data_root = osp.join(osp.abspath(dst_data_root), 'SHHB')
